...
var testprefix = 'arm-cli-vmss-manageddisks-create-tests';
...
var groupName,
  ...
  paramFileName = 'test/data/vmssParamTestMD.json',
  vmssCapacity = 10,
...
describe('arm', function () {
    describe('compute', function () {
        ...
        describe('vmss', function () {
            ...
            it('create-or-update-vmss-manageddisks generate set and remove should pass', function (done) {
                this.timeout(vmTest.timeoutLarge * 10);
