...
nock('http://xplat.blob.core.windows.net:443')
  ...
  'x-ms-request-id': 'd85b9ea6-0001-0014-58aa-3f5563000000',
  'x-ms-version': '2015-12-11',
  date: 'Wed, 16 Nov 2016 01:41:04 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://xplat.blob.core.windows.net:443')
  ...
  vary: 'Origin',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '08840f5b-0001-0045-37aa-3f4b96000000',
  'x-ms-version': '2015-12-11',
  'x-ms-lease-status': 'unlocked',
  'x-ms-lease-state': 'available',
  'x-ms-blob-type': 'BlockBlob',
  'x-ms-server-encrypted': 'false',
  date: 'Wed, 16 Nov 2016 01:41:03 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
