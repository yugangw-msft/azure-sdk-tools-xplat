...
nock('http://xplat.blob.core.windows.net:443')
  ...
  'x-ms-request-id': 'ef0a1ac6-0001-0017-0daa-3f5664000000',
...
nock('http://xplat.blob.core.windows.net:443')
  ...
  vary: 'Origin',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'e7400cbb-0001-0034-54aa-3f39af000000',
  'x-ms-version': '2015-12-11',
  'x-ms-lease-status': 'locked',
  'x-ms-lease-state': 'leased',
  'x-ms-lease-duration': 'infinite',
  date: 'Wed, 16 Nov 2016 01:39:21 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://xplat.blob.core.windows.net:443')
  ...
  vary: 'Origin',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'b52c94a6-0001-0029-25aa-3fe045000000',
  'x-ms-version': '2015-12-11',
  date: 'Wed, 16 Nov 2016 01:39:21 GMT',
  connection: 'close' });
 return result; },
