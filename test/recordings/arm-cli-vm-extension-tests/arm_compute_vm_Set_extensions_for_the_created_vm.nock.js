...
nock('https://management.azure.com:443')
  ...
  'x-ms-request-id': '4527b1c6-d401-419f-a1c5-e3493d264eee',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14966',
  'x-ms-correlation-request-id': 'ea5a6f1c-7233-4a39-83f7-433eb12c7daf',
  'x-ms-routing-request-id': 'WESTINDIA:20161223T084147Z:ea5a6f1c-7233-4a39-83f7-433eb12c7daf',
  date: 'Fri, 23 Dec 2016 08:41:46 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .filteringRequestBody(function (path) { return '*';})
.put('/subscriptions/e00d2b3f-3b94-4dfc-ae8e-ca34c8ba1a99/resourceGroups/xplatTestGExtension9589/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?api-version=2016-03-30', '*')
  ...
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'azure-asyncoperation': 'https://management.azure.com/subscriptions/e00d2b3f-3b94-4dfc-ae8e-ca34c8ba1a99/providers/Microsoft.Compute/locations/westus/operations/65a13d9e-7e5e-48f9-af76-d0baff1e150a?api-version=2016-03-30',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'bb6f807f-4b80-4474-a787-ff1f21f36f46_131263288293570904',
  'x-ms-request-id': '65a13d9e-7e5e-48f9-af76-d0baff1e150a',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-writes': '1193',
  'x-ms-correlation-request-id': 'b3d49356-347e-44bb-b7a5-3024a30ef96d',
  'x-ms-routing-request-id': 'WESTINDIA:20161223T084152Z:b3d49356-347e-44bb-b7a5-3024a30ef96d',
  date: 'Fri, 23 Dec 2016 08:41:52 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .get('/subscriptions/e00d2b3f-3b94-4dfc-ae8e-ca34c8ba1a99/providers/Microsoft.Compute/locations/westus/operations/65a13d9e-7e5e-48f9-af76-d0baff1e150a?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-12-23T08:41:51.8173842+00:00\",\r\n  \"status\": \"InProgress\",\r\n  \"name\": \"65a13d9e-7e5e-48f9-af76-d0baff1e150a\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '134',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'bb6f807f-4b80-4474-a787-ff1f21f36f46_131263288293570904',
  'x-ms-request-id': '037448db-59ee-4e2a-aa12-dc3f635f372e',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14839',
  'x-ms-correlation-request-id': 'fbd50188-cc96-43af-9959-f290abc88125',
  'x-ms-routing-request-id': 'WESTINDIA:20161223T084223Z:fbd50188-cc96-43af-9959-f290abc88125',
  date: 'Fri, 23 Dec 2016 08:42:22 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .get('/subscriptions/e00d2b3f-3b94-4dfc-ae8e-ca34c8ba1a99/providers/Microsoft.Compute/locations/westus/operations/65a13d9e-7e5e-48f9-af76-d0baff1e150a?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-12-23T08:41:51.8173842+00:00\",\r\n  \"endTime\": \"2016-12-23T08:42:29.0798041+00:00\",\r\n  \"status\": \"Succeeded\",\r\n  \"name\": \"65a13d9e-7e5e-48f9-af76-d0baff1e150a\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '184',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'bb6f807f-4b80-4474-a787-ff1f21f36f46_131263288293570904',
  'x-ms-request-id': '2095a9ae-3b5e-4619-8922-0a099b517f53',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14899',
  'x-ms-correlation-request-id': '71c689e1-2207-45bc-b8dc-bc50300b106a',
  'x-ms-routing-request-id': 'WESTINDIA:20161223T084254Z:71c689e1-2207-45bc-b8dc-bc50300b106a',
  date: 'Fri, 23 Dec 2016 08:42:54 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .get('/subscriptions/e00d2b3f-3b94-4dfc-ae8e-ca34c8ba1a99/resourceGroups/xplatTestGExtension9589/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?api-version=2016-03-30')
  .reply(200, "{\r\n  \"properties\": {\r\n    \"publisher\": \"Microsoft.Compute\",\r\n    \"type\": \"VMAccessAgent\",\r\n    \"typeHandlerVersion\": \"2.0\",\r\n    \"autoUpgradeMinorVersion\": false,\r\n    \"forceUpdateTag\": \"extUpdateTag\",\r\n    \"provisioningState\": \"Succeeded\"\r\n  },\r\n  \"type\": \"Microsoft.Compute/virtualMachines/extensions\",\r\n  \"location\": \"westus\",\r\n  \"id\": \"/subscriptions/e00d2b3f-3b94-4dfc-ae8e-ca34c8ba1a99/resourceGroups/xplatTestGExtension9589/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent\",\r\n  \"name\": \"VMAccessAgent\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '542',
  'content-type': 'application/json; charset=utf-8',
  ...
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'bb6f807f-4b80-4474-a787-ff1f21f36f46_131263288293570904',
  'x-ms-request-id': 'ea411abb-184a-4bce-9f64-d25c2f066816',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14965',
  'x-ms-correlation-request-id': '63703200-dc97-4445-bf18-b3c97ea3520e',
  'x-ms-routing-request-id': 'WESTINDIA:20161223T084256Z:63703200-dc97-4445-bf18-b3c97ea3520e',
  date: 'Fri, 23 Dec 2016 08:42:56 GMT' });
 return result; }]];