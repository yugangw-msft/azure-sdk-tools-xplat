...
nock('https://management.azure.com:443')
  ...
  'x-ms-request-id': '37006faf-423f-4c4d-91d3-f2d041bcef3d',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14986',
  'x-ms-correlation-request-id': '8da6ae08-ecc5-44c2-a57d-593730b046d8',
  'x-ms-routing-request-id': 'WESTINDIA:20161007T160414Z:8da6ae08-ecc5-44c2-a57d-593730b046d8',
  date: 'Fri, 07 Oct 2016 16:04:14 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .get('/subscriptions/e00d2b3f-3b94-4dfc-ae8e-ca34c8ba1a99/resourceGroups/xplatTestGExtension9012/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?$expand=instanceView&api-version=2016-03-30')
  ...
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': '90b312a9-a01c-4368-a446-25dd0f6f1f5c_131201851524669513',
  'x-ms-request-id': 'fdd726f7-5355-4414-afc1-6b284acdedea',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14985',
  'x-ms-correlation-request-id': '4bd9b0b3-7092-4b7c-a4f5-6c00fcc5e3a2',
  'x-ms-routing-request-id': 'WESTINDIA:20161007T160416Z:4bd9b0b3-7092-4b7c-a4f5-6c00fcc5e3a2',
  date: 'Fri, 07 Oct 2016 16:04:16 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .delete('/subscriptions/e00d2b3f-3b94-4dfc-ae8e-ca34c8ba1a99/resourceGroups/xplatTestGExtension9012/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?api-version=2016-03-30')
  .reply(202, "", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '0',
  expires: '-1',
  location: 'https://management.azure.com/subscriptions/e00d2b3f-3b94-4dfc-ae8e-ca34c8ba1a99/providers/Microsoft.Compute/locations/eastus/operations/70ad5231-36a7-4ba2-9c14-2b589072b13a?monitor=true&api-version=2016-03-30',
  'azure-asyncoperation': 'https://management.azure.com/subscriptions/e00d2b3f-3b94-4dfc-ae8e-ca34c8ba1a99/providers/Microsoft.Compute/locations/eastus/operations/70ad5231-36a7-4ba2-9c14-2b589072b13a?api-version=2016-03-30',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': '90b312a9-a01c-4368-a446-25dd0f6f1f5c_131201851524669513',
  'x-ms-request-id': '70ad5231-36a7-4ba2-9c14-2b589072b13a',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-writes': '1198',
  'x-ms-correlation-request-id': '9a6428e1-e2ef-4eff-900b-4f7d15dd4ef0',
  'x-ms-routing-request-id': 'WESTINDIA:20161007T160419Z:9a6428e1-e2ef-4eff-900b-4f7d15dd4ef0',
  date: 'Fri, 07 Oct 2016 16:04:19 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .get('/subscriptions/e00d2b3f-3b94-4dfc-ae8e-ca34c8ba1a99/providers/Microsoft.Compute/locations/eastus/operations/70ad5231-36a7-4ba2-9c14-2b589072b13a?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-10-07T16:04:19.0646322+00:00\",\r\n  \"status\": \"InProgress\",\r\n  \"name\": \"70ad5231-36a7-4ba2-9c14-2b589072b13a\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '134',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': '90b312a9-a01c-4368-a446-25dd0f6f1f5c_131201851524669513',
  'x-ms-request-id': '29c7f4a7-5a07-42e5-ad4b-edf80f461359',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14983',
  'x-ms-correlation-request-id': '4d77cfab-c7e3-48c3-88ac-d9dc70f39d3f',
  'x-ms-routing-request-id': 'WESTINDIA:20161007T160451Z:4d77cfab-c7e3-48c3-88ac-d9dc70f39d3f',
  date: 'Fri, 07 Oct 2016 16:04:50 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .get('/subscriptions/e00d2b3f-3b94-4dfc-ae8e-ca34c8ba1a99/providers/Microsoft.Compute/locations/eastus/operations/70ad5231-36a7-4ba2-9c14-2b589072b13a?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-10-07T16:04:19.0646322+00:00\",\r\n  \"endTime\": \"2016-10-07T16:04:58.6115698+00:00\",\r\n  \"status\": \"Succeeded\",\r\n  \"name\": \"70ad5231-36a7-4ba2-9c14-2b589072b13a\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '184',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': '90b312a9-a01c-4368-a446-25dd0f6f1f5c_131201851524669513',
  'x-ms-request-id': '592df65d-f209-4059-8ea6-93e9650e3b17',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14987',
  'x-ms-correlation-request-id': '5572dc25-da4a-4ad2-9ce7-bf06222ad842',
  'x-ms-routing-request-id': 'WESTINDIA:20161007T160523Z:5572dc25-da4a-4ad2-9ce7-bf06222ad842',
  date: 'Fri, 07 Oct 2016 16:05:23 GMT' });
 return result; }]];