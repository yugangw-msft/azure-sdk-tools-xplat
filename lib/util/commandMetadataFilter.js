...
*
* @param {string} cmdMetadata.parameterSet The parameterSet used by the customer while executing the command
*/
...
exports._tagRequest = function (requestOptions, cmdMetadata) {
  ...
  requestOptions.headers[Constants.XMS_PARAMETERSET_NAME] = cmdMetadata.parameterSet;
};
