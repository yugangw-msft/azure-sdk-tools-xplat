...
var cacheOfPlugins = null;
var cacheOfPluginsForMode = null;
...
_.extend(CmdLoader.prototype, {
  ...
  initFromCmdMetadata: function (AzureCli) {
    ...
    if (!cacheOfPlugins || cacheOfPluginsForMode !== this.cmdMode) {
      var data = fs.readFileSync(this.cmdMetadataFile, {encoding: 'utf8'});
      cacheOfPlugins = JSON.parse(data);
      cacheOfPluginsForMode = this.cmdMode;
    }
    var plugins = initCategory(cacheOfPlugins);
