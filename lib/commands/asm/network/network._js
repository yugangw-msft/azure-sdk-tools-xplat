...
exports.init = function (cli) {
  ...
  reservedIP.command('create <name> <location>')
    ...
    .option('-r, --service-name <service-name>', $('the reserved IP service name'))
  ...
  reservedIP.command('associate <name> <service-name> <deployment-name>')
    .usage('[options] <name> <service-name> <deployment-name>')
    .description($('Set a reserved IP address and cloud service association'))
    .option('-s, --subscription <id>', $('the subscription id'))
    .execute(function (name, serviceName, deploymentName, options, _) {
      var networkManagementClient = createNetworkManagementClient(options);
      var reservedIp = new ReservedIp(cli, networkManagementClient);
      reservedIp.associate(name, serviceName, deploymentName, options, _);
    });

  reservedIP.command('disassociate <name> <service-name> <deployment-name>')
    .usage('[options] <name> <service-name> <deployment-name>')
    .description($('Remove a reserved IP address and cloud service association'))
    .option('-s, --subscription <id>', $('the subscription id'))
    .execute(function (name, serviceName, deploymentName, options, _) {
      var networkManagementClient = createNetworkManagementClient(options);
      var reservedIp = new ReservedIp(cli, networkManagementClient);
      reservedIp.disassociate(name, serviceName, deploymentName, options, _);
    });
