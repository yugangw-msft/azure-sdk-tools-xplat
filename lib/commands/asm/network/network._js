...
exports.init = function (cli) {
  ...
  reservedIP.command('associate <name> <service-name>')
    .usage('[options] <name> <service-name>')
    .description($('Set a reserved IP address and cloud service association'))
    .option('-s, --subscription <id>', $('the subscription id'))
    .execute(function (name, serviceName, options, _) {
      var networkManagementClient = createNetworkManagementClient(options);
      var reservedIp = new ReservedIp(cli, networkManagementClient);
      reservedIp.associate(name, serviceName, options, _);
    });

  reservedIP.command('disassociate <name> <service-name>')
    .usage('[options] <name> <service-name>')
    ...
    .execute(function (name, serviceName, options, _) {
      var networkManagementClient = createNetworkManagementClient(options);
      var reservedIp = new ReservedIp(cli, networkManagementClient);
      reservedIp.disassociate(name, serviceName, options, _);
    });
