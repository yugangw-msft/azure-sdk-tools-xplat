...
exports.init = function(cli) {
  ...
  extension.command('set-chef <vm-name>')
    ...
    .option('--daemon <daemon>', $('Use only for windows node. Options: \'auto\' or \'service\'. \'auto\' - Provide when you don\'t want to run the chef-client as service. \'service\' - Provide when you want to run chef-client as service'))
    .execute(function(vmName, options, callback) {
      var vmClient = new VMClient(cli, options.subscription);
