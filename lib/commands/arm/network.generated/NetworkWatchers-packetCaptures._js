...
exports.init = function (cli) {
  ...
  packetCaptures.command('create [resource-group] [watcher-name] [name] [target]')
    ...
    .execute(function(resourceGroup, watcherName, name, target, options, _) {
      ...
      try {
        packetCapture = networkManagementClient.packetCaptures.get(resourceGroup, watcherName, name, null, _);
      } catch (e) {
        if (e.statusCode === 404) {
          packetCapture = null;
        } else {
      ...
      try {
        packetCapture = networkManagementClient.packetCaptures.create(resourceGroup, watcherName, name, parameters, _);
      } finally {
        progress.end();
      }

      cli.interaction.formatOutput(packetCapture, generatorUtils.traverse);
    });
  ...
  packetCaptures.command('delete [resource-group] [watcher-name] [name]')
    ...
    .execute(function(resourceGroup, watcherName, name, options, _) {
      ...
      try {
        packetCapture = networkManagementClient.packetCaptures.deleteMethod(resourceGroup, watcherName, name, _);
    ...
    .execute(function(resourceGroup, watcherName, options, _) {
      ...
      try {
        if(typeof networkManagementClient.packetCaptures.listAll != 'function') {
          ...
          packetCapture = networkManagementClient.packetCaptures.list(resourceGroup, watcherName,  _);
        } else {
          if(options.resourceGroup) {
            ...
            watcherName = cli.interaction.promptIfNotGiven($('network watcher : '), watcherName, _);
            progress = cli.interaction.progress($('Getting the packet captures'));
            packetCapture = networkManagementClient.packetCaptures.listAll(watcherName, _);
          }
        }
      } finally {
        progress.end();
  ...
  packetCaptures.command('status [resource-group] [watcher-name] [name]')
    ...
    .execute(function(resourceGroup, watcherName, name, options, _) {
      ...
      try {
        packetCapture = networkManagementClient.packetCaptures.getStatus(resourceGroup, watcherName, name, _);
      } finally {
        progress.end();
      }
  ...
  packetCaptures.command('stop [resource-group] [watcher-name] [name]')
    ...
    .execute(function(resourceGroup, watcherName, name, options, _) {
      ...
      try {
        packetCapture = networkManagementClient.packetCaptures.stop(resourceGroup, watcherName, name, _);
      } finally {
        progress.end();
      }
