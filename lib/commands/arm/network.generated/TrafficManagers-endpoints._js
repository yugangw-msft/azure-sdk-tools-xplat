...
exports.init = function (cli) {
  ...
  endpoints.command('create [resource-group] [profile-name] [type] [name]')
    ...
    .option('-i, --target-resource-id [target-resource-id]', $('the Azure Resource URI of the of the' +
      '\n     endpoint. Not applicable to endpoints of type \'ExternalEndpoints\''))
    .option('-t, --target [target]', $('the fully-qualified DNS name of the' +
      '\n     endpoint. Traffic Manager returns this value in DNS responses to direct traffic' +
      '\n     to this endpoint'))
    .option('-u, --status [status]', $('the status of the endpoint. If the' +
      '\n     endpoint is Enabled, it is probed for endpoint health and is included in the' +
      '\n     traffic routing method'))
    .option('-w, --weight [weight]', $('the weight of this endpoint when using' +
      '\n     the \'Weighted\' traffic routing method. Possible values are from 1 to 1000'))
    .option('-p, --priority [priority]', $('the priority of this endpoint when' +
    ...
    .option('-c, --min-child-endpoints [min-child-endpoints]', $('the minimum number of endpoints that' +
    ...
    .option('-m, --geo-mapping [geo-mapping]', $('the list of countries/regions mapped to' +
