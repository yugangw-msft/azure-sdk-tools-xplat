...
exports.init = function (cli) {
  ...
  virtualNetworks.command('create [resource-group] [name] [location]')
    ...
    .option('--enable-ddos-protection [enable-ddos-protection]', $('indicates if DDoS protection is enabled' +
      '\n     for all the protected resources in a Virtual Network'))
    .option('--enable-vm-protection [enable-vm-protection]', $('indicates if Vm protection is enabled' +
    ...
    .execute(function(resourceGroup, name, location, options, _) {
      ...
      if(options.addressPrefixes) {
        ...
        parameters.addressSpace.addressPrefixes = parameters.addressSpace.addressPrefixes.concat(generatorUtils.splitStringByCharacter(options.addressPrefixes, ','));
      } else if(useDefaults) {
