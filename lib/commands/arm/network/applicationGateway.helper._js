...
__.extend(AppGateways.prototype, {
  ...
  listAvailableSslOptions: function (options, _) {
    ...
    try {
      var result = self.networkManagementClient.applicationGateways.availableSslOptions(_);
    } finally {
      progress.end();
    }
  ...
  getSslPredefinedPolicy: function (name, options, _) {
    ...
    try {
      var result = self.networkManagementClient.applicationGateways.getSslPredefinedPolicy(name, _);
    } finally {
      progress.end();
    }
  ...
  listSslPredefinedPolicies: function (options, _) {
    ...
    try {
      var result = self.networkManagementClient.applicationGateways.listAvailableSslPredefinedPolicies(_);
    } finally {
      progress.end();
    }
