...
exports.init = function (cli) {
  ...
  appGateway.command('create [resource-group] [name] [location] [servers]')
    ...
    .option('-O, --http-settings-name [http-settings-name]', $('the HTTP settings name'))
    .option('-L, --http-listener-name [http-listener-name]', $('the HTTP listener name'))
    ...
    .option('-j, --frontend-port [frontend-port]', util.format($('the frontend port value, valid range is'),
      utils.toRange(constants.appGateway.settings.port)))
    .option('-J, --frontend-port-name [frontend-port-name]', $('the frontend port name'))
    .option('-F, --frontend-ip-name [frontend-ip-name]', $('the frontend ip name'))
    .option('-A, --address-pool-name [address-pool-name]', $('the address pool name'))
    ...
    .option('-p, --public-ip-id [public-ip-id]', util.format($('the public ip identifier.' +
      '\n     e.g. %s'), constants.help.id.publicIp))
    .option('-G, --gateway-ip-name [gateway-ip-name]', $('the gateway ip name'))
    ...
    .option('-R, --routing-rule-name [routing-rule-name]', $('the routing rule name'))
