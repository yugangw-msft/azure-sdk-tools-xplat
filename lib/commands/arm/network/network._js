...
exports.init = function (cli) {
  ...
  appGatewayUrlPathMapRule.command('create [resource-group] [gateway-name] [name]')
  ...
  appGatewayUrlPathMapRule.command('set [resource-group] [gateway-name] [name]')
  ...
  appGatewayUrlPathMapRule.command('delete [resource-group] [gateway-name] [name]')
