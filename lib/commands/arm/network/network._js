...
exports.init = function (cli) {
  ...
  //     try {
  //       result = networkManagementClient.virtualNetworks.get(resourceGroup, name, null, _);
  //     } catch (e) {
  //       if (e.statusCode === 404) {
  //         result = null;
  //       } else {
  ...
  //     } else if(useDefaults) {
  //       parameters.addressSpace.addressPrefixes = '10.0.0.0/8'.split(',');
  //     }
  ...
  //     try {
  //       result = networkManagementClient.virtualNetworks.createOrUpdate(resourceGroup, name, parameters, _);
  //     } finally {
  //       progress.end();
  //     }
  ...
  //     }
  //     if(options.addressPrefixes) {
  //       if(result && result.addressSpace && result.addressSpace.addressPrefixes) {
  //         parameters.addressSpace.addressPrefixes = result.addressSpace.addressPrefixes;
  //       } else {
  //         parameters.addressSpace.addressPrefixes = [];
  //       }
  //       parameters.addressSpace.addressPrefixes = parameters.addressSpace.addressPrefixes.concat(options.addressPrefixes.split(','));
  ...
  //         delete parameters.dhcpOptions.dnsServers;
  //       } else {
  //         if(result && result.dhcpOptions && result.dhcpOptions.dnsServers) {
  //           parameters.dhcpOptions.dnsServers = result.dhcpOptions.dnsServers;
  //         } else {
  //           parameters.dhcpOptions.dnsServers = [];
  //         }
  //         parameters.dhcpOptions.dnsServers = parameters.dhcpOptions.dnsServers.concat(options.dnsServers.split(','));
  ...
  //     try {
  //       result = networkManagementClient.virtualNetworks.deleteMethod(resourceGroup, name, _);
  ...
  //   .description($('Show virtual network'))
  //   .usage('[options] <resource-group> <name>')
  //   .option('-g, --resource-group <resource-group>', $('the resource group'))
  //   .option('-n, --name <name>', $('the name'))
  //   .option('-s, --subscription <subscription>', $('the subscription identifier'))
  ...
  //         result = networkManagementClient.virtualNetworks.list(resourceGroup,  _);
  //       } else {
  ...
  //         } else {
  //           progress = cli.interaction.progress($('Getting the virtual networks'));
  //           result = networkManagementClient.virtualNetworks.listAll(_);
  //         }
  //       }
  //     } finally {
  //       progress.end();
  ...
  //   });
  //
  // var subnet = virtualNetworks.category('subnet')
