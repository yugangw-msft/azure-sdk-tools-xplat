...
var hdInsightCommandLine = function(cli, userInteractor, executionProcessor) {
  ...
  this.createClusterCommand = function(clusterName, options, _) {
    ...
    */
    ...
    !utils.stringIsNullOrEmpty(options.servicePrincipalTenantId) || 
    ...
    !utils.stringIsNullOrEmpty(options.servicePrincipalCertPassword)) {
      ...
      options.servicePrincipalTenantId = self.user.promptIfNotGiven($('Service Principal AAD Tenant Id: '), options.servicePrincipalTenantId, _);
      ...
      options.clusterIdentity = {
        ...
        aadTenantId: options.servicePrincipalTenantId,
...
hdInsightCommandLine.init = function(cli) {
  ...
  cluster.command('create [clusterName]')
    ...
    .option('--servicePrincipalTenantId <servicePrincipalTenantId>', $('Service principal AAD Tenant Id used to access Azure Data Lake Store ' + 
