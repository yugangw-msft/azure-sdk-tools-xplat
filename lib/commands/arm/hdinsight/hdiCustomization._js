...
__.extend(HdiCustomization.prototype, {
  ...
  getCoreSiteConfigurationsForADLS : function(configurations, storageAccountDetails){
    var coreConfig = configurations[HDIConstants.ConfigurationKey.CoreSite];
    if (coreConfig === null || coreConfig === undefined) {
      coreConfig = {};
  ...
  getClusterIdentityConfigurations : function(configurations, clusterIdentityDetails, _){ 
    ...
    if((clusterIdentityConfig === null || clusterIdentityConfig === undefined) && 
    (clusterIdentityDetails !== null && clusterIdentityDetails !== undefined)) {    
      ...
      clusterIdentityConfig['clusterIdentity.aadTenantId'] = 'https://login.windows.net/' + clusterIdentityDetails.aadTenantId;
  ...
  getConfigurations: function(clusterName, clusterCreateParameters, _) {
    ...
    //Core Config  
    if(utils.ignoreCaseEquals(clusterCreateParameters.defaultStorageType, 'WASB')){
      ...
      coreConfig = this.getCoreSiteConfigurationsForADLS(configurations, clusterCreateParameters.defaultStorageAccountDetails);
    }    
