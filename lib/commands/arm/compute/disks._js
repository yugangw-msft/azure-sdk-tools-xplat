...
azure managed-disk config zones set
--parameter-file $f
--index $i
--value $v
--parse

azure managed-disk config zones delete
--parameter-file $f
--index $pindex
...
*/
  ...
  .execute(function(options, _) {
    ...
    options.path = '';
    var anySubItem = false || options.managedBy || options.sku || options.zones || options.timeCreated || options.osType || options.creationData || options.diskSizeGB || options.encryptionSettings || options.provisioningState || options.id || options.name || options.type || options.location || options.tags;
    if (anySubItem) {
  ...
  var parametersCreateOrUpdateDisksZones0Z1 = catparametersCreateOrUpdateDisksZones0Z1.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var setparametersCreateOrUpdateDisksZones0Z1 = parametersCreateOrUpdateDisksZones0Z1.category('zones')
  .description($('Commands to configure zones of managed-disk in config file.'));
  setparametersCreateOrUpdateDisksZones0Z1.command('set')
  ...
  var parametersCreateOrUpdateDisksZones1Z1 = catparametersCreateOrUpdateDisksZones1Z1.category('config')
  .description($('Commands to manage configuration of disks in the parameter file.'));
  var deleteparametersCreateOrUpdateDisksZones1Z1 = parametersCreateOrUpdateDisksZones1Z1.category('zones')
  .description($('Commands to configure zones of managed-disk in config file.'));
  deleteparametersCreateOrUpdateDisksZones1Z1.command('delete')
