...
azure vm config disks-encryption-settings set
--parameter-file $f
--index $i
--disks-index $i
--value $v
...
azure vm config disks-encryption-settings delete
--parameter-file $f
--index $pindex
...
azure vm config encryption-settings-disk-encryption-key set
--parameter-file $f
--encryption-settings-index $i
--disks-index $i
--parse
--secret-url $secretUrl
--source-vault $sourceVault

azure vm config encryption-settings-disk-encryption-key delete
--parameter-file $f
--encryption-settings-index $pencryption-settings-index
--disks-index $pdisks-index
--secret-url
--source-vault

azure vm config disk-encryption-key-source-vault set
--parameter-file $f
--encryption-settings-index $i
--disks-index $i
--parse
...
azure vm config disk-encryption-key-source-vault delete
--parameter-file $f
--encryption-settings-index $pencryption-settings-index
--disks-index $pdisks-index
--id

azure vm config encryption-settings-key-encryption-key set
--parameter-file $f
--encryption-settings-index $i
--disks-index $i
--parse
...
azure vm config encryption-settings-key-encryption-key delete
--parameter-file $f
--encryption-settings-index $pencryption-settings-index
--disks-index $pdisks-index
--key-url
...
azure vm config zones set
--parameter-file $f
--index $i
--value $v
--parse

azure vm config zones delete
--parameter-file $f
--index $pindex
...
azure vm run-command-parameters script set
--parameter-file $f
--index $i
--value $v
--parse

azure vm run-command-parameters script delete
--parameter-file $f
--index $pindex
...
*/
  ...
  .execute(function(options, _) {
    ...
    options.operation = 'remove';
    options.path = '/instanceView/disks' + (options.index ? ('/' + options.index) : '');
    var anySubItem = false || options.name || options.encryptionSettings || options.statuses;
    if (anySubItem) {
      var subItemPath = null;
      if (options.name) {
        subItemPath = options.path + '/name';
  ...
  //config set disks-encryption-settings
  var catparametersCreateOrUpdateVirtualMachinesEncryptionSettings0IVdIeS2 = cli.category('vm');
  var parametersCreateOrUpdateVirtualMachinesEncryptionSettings0IVdIeS2 = catparametersCreateOrUpdateVirtualMachinesEncryptionSettings0IVdIeS2.category('config')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var setparametersCreateOrUpdateVirtualMachinesEncryptionSettings0IVdIeS2 = parametersCreateOrUpdateVirtualMachinesEncryptionSettings0IVdIeS2.category('disks-encryption-settings')
  .description($('Commands to configure disks-encryption-settings of vm in config file.'));
  setparametersCreateOrUpdateVirtualMachinesEncryptionSettings0IVdIeS2.command('set')
  ...
  //config delete disks-encryption-settings
  var catparametersCreateOrUpdateVirtualMachinesEncryptionSettings1IVdIeS2 = cli.category('vm');
  var parametersCreateOrUpdateVirtualMachinesEncryptionSettings1IVdIeS2 = catparametersCreateOrUpdateVirtualMachinesEncryptionSettings1IVdIeS2.category('config')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var deleteparametersCreateOrUpdateVirtualMachinesEncryptionSettings1IVdIeS2 = parametersCreateOrUpdateVirtualMachinesEncryptionSettings1IVdIeS2.category('disks-encryption-settings')
  .description($('Commands to configure disks-encryption-settings of vm in config file.'));
  deleteparametersCreateOrUpdateVirtualMachinesEncryptionSettings1IVdIeS2.command('delete')
  ...
  //config set encryption-settings-disk-encryption-key
  var catparametersCreateOrUpdateVirtualMachinesDiskEncryptionKey0IVdIeSSIdEK2 = cli.category('vm');
  var parametersCreateOrUpdateVirtualMachinesDiskEncryptionKey0IVdIeSSIdEK2 = catparametersCreateOrUpdateVirtualMachinesDiskEncryptionKey0IVdIeSSIdEK2.category('config')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var setparametersCreateOrUpdateVirtualMachinesDiskEncryptionKey0IVdIeSSIdEK2 = parametersCreateOrUpdateVirtualMachinesDiskEncryptionKey0IVdIeSSIdEK2.category('encryption-settings-disk-encryption-key')
  .description($('Commands to configure encryption-settings-disk-encryption-key of vm in config file.'));
  setparametersCreateOrUpdateVirtualMachinesDiskEncryptionKey0IVdIeSSIdEK2.command('set')
  .description($('Set encryption-settings-disk-encryption-key in config string or files, e.g. \r\n         {\r\n           ...\r\n           "diskEncryptionKey" : {\r\n             "secretUrl":"",\r\n             "sourceVault":{\r\n               "id":""\r\n             }\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, \'vmss show/list/stop\' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas \'vmss config * generate/create/set/delete/add\' commands \r\n         are used to configure the input parameter file. The \'vmss config\' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.'))
  .usage('[options]')
  .option('--parameter-file <parameter-file>', $('The parameter file path.'))
  .option('--encryption-settings-index <encryption-settings-index>', $('Indexer: encryption-settings-index.'))
  .option('--disks-index <disks-index>', $('Indexer: disks-index.'))
  .option('--parse', $('Parse the input string, i.e. str, for parameters to a JSON object, e.g. JSON.parse(str).'))
  .option('--secret-url <secretUrl>', $('Set the secret-url value.'))
  .option('--source-vault <sourceVault>', $('Set the source-vault value.'))
  ...
  //config delete encryption-settings-disk-encryption-key
  var catparametersCreateOrUpdateVirtualMachinesDiskEncryptionKey1IVdIeSSIdEK2 = cli.category('vm');
  var parametersCreateOrUpdateVirtualMachinesDiskEncryptionKey1IVdIeSSIdEK2 = catparametersCreateOrUpdateVirtualMachinesDiskEncryptionKey1IVdIeSSIdEK2.category('config')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var deleteparametersCreateOrUpdateVirtualMachinesDiskEncryptionKey1IVdIeSSIdEK2 = parametersCreateOrUpdateVirtualMachinesDiskEncryptionKey1IVdIeSSIdEK2.category('encryption-settings-disk-encryption-key')
  .description($('Commands to configure encryption-settings-disk-encryption-key of vm in config file.'));
  deleteparametersCreateOrUpdateVirtualMachinesDiskEncryptionKey1IVdIeSSIdEK2.command('delete')
  ...
  //config set disk-encryption-key-source-vault
  var catparametersCreateOrUpdateVirtualMachinesSourceVault0IVdIeSSIdEKsV2 = cli.category('vm');
  var parametersCreateOrUpdateVirtualMachinesSourceVault0IVdIeSSIdEKsV2 = catparametersCreateOrUpdateVirtualMachinesSourceVault0IVdIeSSIdEKsV2.category('config')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var setparametersCreateOrUpdateVirtualMachinesSourceVault0IVdIeSSIdEKsV2 = parametersCreateOrUpdateVirtualMachinesSourceVault0IVdIeSSIdEKsV2.category('disk-encryption-key-source-vault')
  .description($('Commands to configure disk-encryption-key-source-vault of vm in config file.'));
  setparametersCreateOrUpdateVirtualMachinesSourceVault0IVdIeSSIdEKsV2.command('set')
  ...
  //config delete disk-encryption-key-source-vault
  var catparametersCreateOrUpdateVirtualMachinesSourceVault1IVdIeSSIdEKsV2 = cli.category('vm');
  var parametersCreateOrUpdateVirtualMachinesSourceVault1IVdIeSSIdEKsV2 = catparametersCreateOrUpdateVirtualMachinesSourceVault1IVdIeSSIdEKsV2.category('config')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var deleteparametersCreateOrUpdateVirtualMachinesSourceVault1IVdIeSSIdEKsV2 = parametersCreateOrUpdateVirtualMachinesSourceVault1IVdIeSSIdEKsV2.category('disk-encryption-key-source-vault')
  .description($('Commands to configure disk-encryption-key-source-vault of vm in config file.'));
  deleteparametersCreateOrUpdateVirtualMachinesSourceVault1IVdIeSSIdEKsV2.command('delete')
  ...
  //config set encryption-settings-key-encryption-key
  var catparametersCreateOrUpdateVirtualMachinesKeyEncryptionKey0IVdIeSSIkEK2 = cli.category('vm');
  var parametersCreateOrUpdateVirtualMachinesKeyEncryptionKey0IVdIeSSIkEK2 = catparametersCreateOrUpdateVirtualMachinesKeyEncryptionKey0IVdIeSSIkEK2.category('config')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var setparametersCreateOrUpdateVirtualMachinesKeyEncryptionKey0IVdIeSSIkEK2 = parametersCreateOrUpdateVirtualMachinesKeyEncryptionKey0IVdIeSSIkEK2.category('encryption-settings-key-encryption-key')
  .description($('Commands to configure encryption-settings-key-encryption-key of vm in config file.'));
  setparametersCreateOrUpdateVirtualMachinesKeyEncryptionKey0IVdIeSSIkEK2.command('set')
  ...
  //config delete encryption-settings-key-encryption-key
  var catparametersCreateOrUpdateVirtualMachinesKeyEncryptionKey1IVdIeSSIkEK2 = cli.category('vm');
  var parametersCreateOrUpdateVirtualMachinesKeyEncryptionKey1IVdIeSSIkEK2 = catparametersCreateOrUpdateVirtualMachinesKeyEncryptionKey1IVdIeSSIkEK2.category('config')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var deleteparametersCreateOrUpdateVirtualMachinesKeyEncryptionKey1IVdIeSSIkEK2 = parametersCreateOrUpdateVirtualMachinesKeyEncryptionKey1IVdIeSSIkEK2.category('encryption-settings-key-encryption-key')
  .description($('Commands to configure encryption-settings-key-encryption-key of vm in config file.'));
  deleteparametersCreateOrUpdateVirtualMachinesKeyEncryptionKey1IVdIeSSIkEK2.command('delete')
  ...
  var parametersCreateOrUpdateVirtualMachinesSourceVault0IVdIeSSIkEKsV2 = catparametersCreateOrUpdateVirtualMachinesSourceVault0IVdIeSSIkEKsV2.category('config')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var setparametersCreateOrUpdateVirtualMachinesSourceVault0IVdIeSSIkEKsV2 = parametersCreateOrUpdateVirtualMachinesSourceVault0IVdIeSSIkEKsV2.category('key-encryption-key-source-vault')
  .description($('Commands to configure key-encryption-key-source-vault of vm in config file.'));
  setparametersCreateOrUpdateVirtualMachinesSourceVault0IVdIeSSIkEKsV2.command('set')
  .description($('Set key-encryption-key-source-vault in config string or files, e.g. \r\n         {\r\n           ...\r\n           "sourceVault" : {\r\n             "id":""\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, \'vmss show/list/stop\' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas \'vmss config * generate/create/set/delete/add\' commands \r\n         are used to configure the input parameter file. The \'vmss config\' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.'))
  .usage('[options]')
  .option('--parameter-file <parameter-file>', $('The parameter file path.'))
  .option('--encryption-settings-index <encryption-settings-index>', $('Indexer: encryption-settings-index.'))
  ...
  var parametersCreateOrUpdateVirtualMachinesSourceVault1IVdIeSSIkEKsV2 = catparametersCreateOrUpdateVirtualMachinesSourceVault1IVdIeSSIkEKsV2.category('config')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var deleteparametersCreateOrUpdateVirtualMachinesSourceVault1IVdIeSSIkEKsV2 = parametersCreateOrUpdateVirtualMachinesSourceVault1IVdIeSSIkEKsV2.category('key-encryption-key-source-vault')
  .description($('Commands to configure key-encryption-key-source-vault of vm in config file.'));
  deleteparametersCreateOrUpdateVirtualMachinesSourceVault1IVdIeSSIkEKsV2.command('delete')
  .description($('Remove key-encryption-key-source-vault in config string or files, e.g. \r\n         {\r\n           ...\r\n           "sourceVault" : {\r\n             "id":""\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, \'vmss show/list/stop\' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas \'vmss config * generate/create/set/delete/add\' commands \r\n         are used to configure the input parameter file. The \'vmss config\' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.'))
  .usage('[options]')
  .option('--parameter-file <parameter-file>', $('The parameter file path.'))
  .option('--encryption-settings-index <encryption-settings-index>', $('Indexer: encryption-settings-index.'))
  ...
  var parametersCreateOrUpdateVirtualMachinesZones0Z1 = catparametersCreateOrUpdateVirtualMachinesZones0Z1.category('config')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var setparametersCreateOrUpdateVirtualMachinesZones0Z1 = parametersCreateOrUpdateVirtualMachinesZones0Z1.category('zones')
  .description($('Commands to configure zones of vm in config file.'));
  setparametersCreateOrUpdateVirtualMachinesZones0Z1.command('set')
  ...
  var parametersCreateOrUpdateVirtualMachinesZones1Z1 = catparametersCreateOrUpdateVirtualMachinesZones1Z1.category('config')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var deleteparametersCreateOrUpdateVirtualMachinesZones1Z1 = parametersCreateOrUpdateVirtualMachinesZones1Z1.category('zones')
  .description($('Commands to configure zones of vm in config file.'));
  deleteparametersCreateOrUpdateVirtualMachinesZones1Z1.command('delete')
...
/*
  ...
  --vm-name
*/
  var virtualMachinesInstanceView = cli.category('vm')
  .description($('Commands to manage your virtual machines.  '));
  virtualMachinesInstanceView.command('instance-view [resource-group] [vm-name]')
  ...
  .execute(function(resourceGroup, vMName, options, _) {
    ...
    var subscription = profile.current.getSubscription(options.subscription);
    var computeManagementClient = utils.createComputeManagementClient(subscription);
    var result = computeManagementClient.virtualMachines.instanceView(resourceGroup, vMName, _);
    if (result) {
      cli.output.json(result);
    }
  });
...
*/
  ...
  .option('--parameter-file <parameter-file>', $('The parameter file path.'))
  .execute(function(options, _) {
    cli.output.verbose('{\"commandId\":\"\",\"script\":[\"\"],\"parameters\":[{\"name\":\"\",\"value\":\"\"}]}', _);
  ...
  .option('--script <script>', $('Set the script value.'))
  ...
  .option('--script', $('Remove the script value.'))
  ...
  .execute(function(options, _) {
    ...
    options.operation = 'remove';
    options.path = '';
    var anySubItem = false || options.commandId || options.script || options.parameters;
    if (anySubItem) {
      var subItemPath = null;
      if (options.commandId) {
  ...
  //run-command-parameters set script
  var catparametersRunCommandVirtualMachinesScript0S1 = cli.category('vm');
  var parametersRunCommandVirtualMachinesScript0S1 = catparametersRunCommandVirtualMachinesScript0S1.category('run-command-parameters')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var setparametersRunCommandVirtualMachinesScript0S1 = parametersRunCommandVirtualMachinesScript0S1.category('script')
  .description($('Commands to configure script of vm in run-command-parameters file.'));
  setparametersRunCommandVirtualMachinesScript0S1.command('set')
  ...
  //run-command-parameters delete script
  var catparametersRunCommandVirtualMachinesScript1S1 = cli.category('vm');
  var parametersRunCommandVirtualMachinesScript1S1 = catparametersRunCommandVirtualMachinesScript1S1.category('run-command-parameters')
  .description($('Commands to manage configuration of virtual-machines in the parameter file.'));
  var deleteparametersRunCommandVirtualMachinesScript1S1 = parametersRunCommandVirtualMachinesScript1S1.category('script')
  .description($('Commands to configure script of vm in run-command-parameters file.'));
  deleteparametersRunCommandVirtualMachinesScript1S1.command('delete')
