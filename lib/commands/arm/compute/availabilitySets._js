...
*/
  ...
  .execute(function(options, _) {
    cli.output.verbose('{\"platformUpdateDomainCount\":null,\"platformFaultDomainCount\":null,\"virtualMachines\":[{\"id\":\"\"}],\"statuses\":[{\"code\":\"\",\"level\":null,\"displayStatus\":\"\",\"message\":\"\",\"time\":null}],\"managed\":null,\"sku\":{\"name\":\"\",\"tier\":\"\",\"capacity\":null},\"id\":null,\"name\":null,\"type\":null,\"location\":\"\",\"tags\":{}}', _);
  ...
  var catparametersCreateOrUpdateAvailabilitySetsAvailabilitySet0 = cli.category('availset');
  var parametersCreateOrUpdateAvailabilitySetsAvailabilitySet0 = catparametersCreateOrUpdateAvailabilitySetsAvailabilitySet0.category('config')
  .description($('Commands to manage configuration of availability-sets in the parameter file.'));
  var setparametersCreateOrUpdateAvailabilitySetsAvailabilitySet0 = parametersCreateOrUpdateAvailabilitySetsAvailabilitySet0.category('availability-set')
  .description($('Commands to configure availability-set of availset in config file.'));
  setparametersCreateOrUpdateAvailabilitySetsAvailabilitySet0.command('set')
  ...
  .option('--managed <managed>', $('Set the managed value.'))
  ...
  .execute(function(options, _) {
    ...
    paramPath = options.path + '/' + 'managed';
    if (options.managed) {
      cli.output.verbose('================================================');
      cli.output.verbose('Path  : ' + paramPath);
      cli.output.verbose('Value : ' + options.managed);
      cli.output.verbose('================================================');
      if (options.parse && options.managed) {
        options.managed = JSON.parse(options.managed);
      }
      options.managed = JSON.parse(options.managed);
      jsonpatch.apply(parametersObj, [{op: options.operation, path: paramPath, value: options.managed}]);
    }
  ...
  var catparametersCreateOrUpdateAvailabilitySetsAvailabilitySet1 = cli.category('availset');
  var parametersCreateOrUpdateAvailabilitySetsAvailabilitySet1 = catparametersCreateOrUpdateAvailabilitySetsAvailabilitySet1.category('config')
  .description($('Commands to manage configuration of availability-sets in the parameter file.'));
  var deleteparametersCreateOrUpdateAvailabilitySetsAvailabilitySet1 = parametersCreateOrUpdateAvailabilitySetsAvailabilitySet1.category('availability-set')
  .description($('Commands to configure availability-set of availset in config file.'));
  deleteparametersCreateOrUpdateAvailabilitySetsAvailabilitySet1.command('delete')
  ...
  .option('--managed', $('Remove the managed value.'))
  ...
  .execute(function(options, _) {
    ...
    options.path = '';
    var anySubItem = false || options.platformUpdateDomainCount || options.platformFaultDomainCount || options.virtualMachines || options.statuses || options.managed || options.sku || options.id || options.name || options.type || options.location || options.tags;
    if (anySubItem) {
      ...
      if (options.managed) {
        subItemPath = options.path + '/managed';
        jsonpatch.apply(parametersObj, [{op: options.operation, path: subItemPath}]);
      }
      if (options.sku) {
  ...
  var catparametersCreateOrUpdateAvailabilitySetsVirtualMachines0VM = cli.category('availset');
  var parametersCreateOrUpdateAvailabilitySetsVirtualMachines0VM = catparametersCreateOrUpdateAvailabilitySetsVirtualMachines0VM.category('config')
  .description($('Commands to manage configuration of availability-sets in the parameter file.'));
  var setparametersCreateOrUpdateAvailabilitySetsVirtualMachines0VM = parametersCreateOrUpdateAvailabilitySetsVirtualMachines0VM.category('virtual-machines')
  .description($('Commands to configure virtual-machines of availset in config file.'));
  setparametersCreateOrUpdateAvailabilitySetsVirtualMachines0VM.command('set')
  ...
  var catparametersCreateOrUpdateAvailabilitySetsVirtualMachines1VM = cli.category('availset');
  var parametersCreateOrUpdateAvailabilitySetsVirtualMachines1VM = catparametersCreateOrUpdateAvailabilitySetsVirtualMachines1VM.category('config')
  .description($('Commands to manage configuration of availability-sets in the parameter file.'));
  var deleteparametersCreateOrUpdateAvailabilitySetsVirtualMachines1VM = parametersCreateOrUpdateAvailabilitySetsVirtualMachines1VM.category('virtual-machines')
  .description($('Commands to configure virtual-machines of availset in config file.'));
  deleteparametersCreateOrUpdateAvailabilitySetsVirtualMachines1VM.command('delete')
  ...
  //config set statuses
  var catparametersCreateOrUpdateAvailabilitySetsStatuses0S = cli.category('availset');
  var parametersCreateOrUpdateAvailabilitySetsStatuses0S = catparametersCreateOrUpdateAvailabilitySetsStatuses0S.category('config')
  .description($('Commands to manage configuration of availability-sets in the parameter file.'));
  var setparametersCreateOrUpdateAvailabilitySetsStatuses0S = parametersCreateOrUpdateAvailabilitySetsStatuses0S.category('statuses')
  .description($('Commands to configure statuses of availset in config file.'));
  setparametersCreateOrUpdateAvailabilitySetsStatuses0S.command('set')
  ...
  var catparametersCreateOrUpdateAvailabilitySetsStatuses1S = cli.category('availset');
  var parametersCreateOrUpdateAvailabilitySetsStatuses1S = catparametersCreateOrUpdateAvailabilitySetsStatuses1S.category('config')
  .description($('Commands to manage configuration of availability-sets in the parameter file.'));
  var deleteparametersCreateOrUpdateAvailabilitySetsStatuses1S = parametersCreateOrUpdateAvailabilitySetsStatuses1S.category('statuses')
  .description($('Commands to configure statuses of availset in config file.'));
  deleteparametersCreateOrUpdateAvailabilitySetsStatuses1S.command('delete')
  ...
  //config set sku
  var catparametersCreateOrUpdateAvailabilitySetsSku0S = cli.category('availset');
  var parametersCreateOrUpdateAvailabilitySetsSku0S = catparametersCreateOrUpdateAvailabilitySetsSku0S.category('config')
  .description($('Commands to manage configuration of availability-sets in the parameter file.'));
  var setparametersCreateOrUpdateAvailabilitySetsSku0S = parametersCreateOrUpdateAvailabilitySetsSku0S.category('sku')
  .description($('Commands to configure sku of availset in config file.'));
  setparametersCreateOrUpdateAvailabilitySetsSku0S.command('set')
  ...
  //config delete sku
  var catparametersCreateOrUpdateAvailabilitySetsSku1S = cli.category('availset');
  var parametersCreateOrUpdateAvailabilitySetsSku1S = catparametersCreateOrUpdateAvailabilitySetsSku1S.category('config')
  .description($('Commands to manage configuration of availability-sets in the parameter file.'));
  var deleteparametersCreateOrUpdateAvailabilitySetsSku1S = parametersCreateOrUpdateAvailabilitySetsSku1S.category('sku')
  .description($('Commands to configure sku of availset in config file.'));
  deleteparametersCreateOrUpdateAvailabilitySetsSku1S.command('delete')
